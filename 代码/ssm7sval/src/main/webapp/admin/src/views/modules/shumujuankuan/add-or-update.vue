<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐款公告标题" prop="juankuangonggaobiaoti">
          <el-input v-model="ruleForm.juankuangonggaobiaoti" 
              placeholder="捐款公告标题" clearable  :readonly="ro.juankuangonggaobiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐款公告标题" prop="juankuangonggaobiaoti">
              <el-input v-model="ruleForm.juankuangonggaobiaoti" 
                placeholder="捐款公告标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐款内容" prop="juankuanneirong">
          <el-input v-model="ruleForm.juankuanneirong" 
              placeholder="捐款内容" clearable  :readonly="ro.juankuanneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐款内容" prop="juankuanneirong">
              <el-input v-model="ruleForm.juankuanneirong" 
                placeholder="捐款内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐款价格" prop="juankuanjiage">
          <el-input v-model="ruleForm.juankuanjiage" 
              placeholder="捐款价格" clearable  :readonly="ro.juankuanjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐款价格" prop="juankuanjiage">
              <el-input v-model="ruleForm.juankuanjiage" 
                placeholder="捐款价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shumujuankuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shumujuankuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
